/**
 * The built-in tools' settings panels, one component per tool, exported so the plugin registry
 * can name them (see plugins/builtins.tsx). `ToolSettings.tsx` is only the box they sit in.
 */
...
export function DrawSettings(): JSX.Element {
...
export function SelectSettings(): JSX.Element {
...
export function ManipulateSettings(): JSX.Element {
...
export function BondCentricSettings(): JSX.Element {
...
export function MeasureReadout(): JSX.Element {
...
export function AutoRotateSettings(): JSX.Element {
...
export function AutoOptimizeSettings(): JSX.Element {
