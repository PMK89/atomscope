...
| Avogadro 1 source tree (`avogadro-master`) | `/media/pmk/SysEx/cs/paw/avogadro/avogadro-master` | GPL-2.0-or-later | Feature inventory, fragments/crystals data (if copied) |
